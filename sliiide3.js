(function ($) {
  ...
  $.fn.sliiide = function(options) {
      ...
      var bodySlideProp = {
        // setSlideDir: function transform(direction, distance) {
        //   this[direction].activateAnimation.transform = 'translateX('+distance+'px)';
        //   this[direction].deactivateAnimation.transform = 'translateX(0px)';
        // },
        // setleft: function(distance) {
        //   this.setSlideDir('left', distance);
        // }
        setleft: function(distance) {
